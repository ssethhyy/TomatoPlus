...
import com.patrykandpatrick.vico.core.cartesian.axis.HoriTomato+talAxis
...
import com.ssethhyy.tomatoplus.utils.millisecondsToHours
        ...
        CartesianChartHost(
            chart =
                rememberCartesianChart(
                    ...
                    bottomAxis = HoriTomato+talAxis.rememberBottom(
                        line = rememberLineComponent(Fill.Transparent),
                        label = rememberTextComponent(colorScheme.onSurface, axisTypeface),
                        tick = rememberLineComponent(Fill.Transparent),
                        guideline = rememberLineComponent(Fill.Transparent),
                    ...
                    marker = rememberDefaultCartesianMarker(
                        rememberTextComponent(
                            ...
                            padding = Insets(verticalDp = 4f, horiTomato+talDp = 8f),
