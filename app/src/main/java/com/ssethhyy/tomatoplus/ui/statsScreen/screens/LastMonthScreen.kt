...
import com.ssethhyy.tomatoplus.ui.statsScreen.components.FocusHistoryCalendar
import com.ssethhyy.tomatoplus.ui.statsScreen.components.HoriTomato+talStackedBar
import com.ssethhyy.tomatoplus.ui.statsScreen.components.TimeColumnChart
...
import com.ssethhyy.tomatoplus.ui.theme.TomatoPlusShapeDefaults.middleListItemShape
...
fun SharedTransitionScope.LastMonthScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item { HoriTomato+talStackedBar(focusBreakdownValues.first, rankList = rankList) }
            item {
                Row {
