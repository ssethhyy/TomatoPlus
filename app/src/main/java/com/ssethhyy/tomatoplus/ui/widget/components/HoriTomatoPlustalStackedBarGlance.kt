...
package com.ssethhyy.tomatoplus.ui.widget.components
...
import com.ssethhyy.tomatoplus.ui.statsScreen.components.HORITomato+TAL_STACKED_BAR_HEIGHT

/**
 * A version of HoriTomato+talStackedBar that uses Glance composables for use in widgets.
 */
@Composable
@GlanceComposable
fun HoriTomato+talStackedBarGlance(
    values: List<Long>,
    width: Dp,
